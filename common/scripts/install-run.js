...
/******/ (() => {
  ...
  \************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function _copyAndTrimNpmrcFile(options) {
          const { logger, sourceNpmrcPath, targetNpmrcPath, linesToPrepend, linesToAppend } =
            options;
  ...
  \*******************************************/
    ...
    /* harmony import */ var os__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! os */ 822037
    );
    ...
    function _run() {
      ...
      if (
        path__WEBPACK_IMPORTED_MODULE_3__.basename(scriptPath).toLowerCase() !== 'install-run.js'
      ) {
